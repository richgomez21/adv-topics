...
$numGmail = 0;
foreach($emails as $e){
	if(strpos($e,"gmail.com")){
		$numGmail++;
	}
}
echo("Number of Gmail accounts: $numGmail");
...
//$dogs[0].name // THIS WONT WORK
var_dump($dogs); // USE BRACKET NOTATION INSTEAD
